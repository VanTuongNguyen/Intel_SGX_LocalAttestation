...
$(UNTRUSTED_DIR)/encl1_u.c: $(SGX_EDGER8R) $(TRUSTED_DIR)/encl1.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../$(TRUSTED_DIR)/encl1.edl --search-path ../$(TRUSTED_DIR) --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"
